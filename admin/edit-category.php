  ...
  if (isset($_GET['id'])) {
    ...
    $data = mysqli_fetch_assoc($result);
      // apabila data tidak ada pada database maka akan dijalankan perintah ini
       if (!$data) {
          echo "<script>alert('Kategoru tidak ditemukan pada database');window.location='./index.php';</script>";
       }
  } else {
...
<html>
  ...
  <body>
    <section class="w-full md:w-4/5 bg-slate-300 m-auto p-4 md:p-8 lg:md-12">
      ...
      <form method="POST" action="editing-category.php" enctype="multipart/form-data" >
